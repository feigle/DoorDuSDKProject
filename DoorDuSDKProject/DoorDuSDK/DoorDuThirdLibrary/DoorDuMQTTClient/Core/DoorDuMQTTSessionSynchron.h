...
@interface DoorDuMQTTSession(Synchron)

/** connects to the specified DoorDuMQTT server synchronously
...
/** closes an DoorDuMQTTSession gracefully synchronously
