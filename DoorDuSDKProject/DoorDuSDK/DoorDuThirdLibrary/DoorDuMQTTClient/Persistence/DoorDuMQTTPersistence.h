...
static BOOL const DoorDuMQTT_PERSISTENT = NO;
static NSInteger const DoorDuMQTT_MAX_SIZE = 64 * 1024 * 1024;
static NSInteger const DoorDuMQTT_MAX_WINDOW_SIZE = 16;
static NSInteger const DoorDuMQTT_MAX_MESSAGES = 1024;

/** MQTTFlow is an abstraction of the entity to be stored for persistence */
 
@protocol DoorDuMQTTFlow
...
@protocol DoorDuMQTTPersistence
 ...
 */
- (id<DoorDuMQTTFlow>)storeMessageForClientId:(NSString *)clientId
 ...
 * @param flow
 */
- (void)deleteFlow:(id<DoorDuMQTTFlow>)flow;
 ...
 */
- (id<DoorDuMQTTFlow>)flowforClientId:(NSString *)clientId
                   incomingFlag:(BOOL)incomingFlag
